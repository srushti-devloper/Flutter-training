...
class Guess10 extends StatefulWidget {
  int s18 = 0;
  Guess10({super.key, required this.s18});

  @override
  State<Guess10> createState() => _Guess10State();
}

class _Guess10State extends State<Guess10> {
